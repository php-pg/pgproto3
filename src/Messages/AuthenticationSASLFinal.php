...
class AuthenticationSASLFinal implements AuthenticationResponseMessage
{
    use MessageName;

    public const AUTH_TYPE = AuthType::AuthTypeSASLFinal;
    ...
    public function decode(string $data): void
    {
        ...
        if ($authType !== AuthType::AuthTypeSASLFinal->value) {
            throw new InvalidMessageFormatException($this->getName());
        }
